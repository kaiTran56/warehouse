...
public interface OrderScheduleRepository
	...
	@Query(value = "select * from order_schedules where phone like :phone and product_code like :productCode and ord.delete_status = 1", nativeQuery = true)
	List<OrderScheduleEntity> getByPhoneAndProductCode(@Param("phone") String phone,
			@Param("productCode") String productCode);

	@Modifying
	@Query(value = "update order_schedules set delete_status = 0;", nativeQuery = true)
	void deleteAll();
}
